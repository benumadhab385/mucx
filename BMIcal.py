...
top_frame = Frame(window, width=295, height = 50, bg=co2, pady=0,padx=0)
...
def calculate():
    ...
    if result <= 18.4:
        l_result_text['text'] = "Your BMI is : underweigth"
...
l_weight = Label(down_frame,text = "enter your weight", height=1,padx=1,anchor="center",font=("Ivy 10 bold"), bg = co1,fg=co0)
l_weight.grid(row=3,column=0,columnspan=1,pady=1,padx=3)
e_weight = Entry(down_frame, width=5,font=("Ivy 10 bold"),justify="center", relief=SOLID)
e_weight.grid(row=3, column=1, columnspan=1,pady=10,padx=3)

l_height = Label(down_frame,text = "enter your height", height=1,padx=1,anchor="center",font=("Ivy 10 bold"), bg = co1,fg=co0)
l_height.grid(row=2,column=0,columnspan=1,pady=10,padx=3)
e_height = Entry(down_frame, width=5,font=("Ivy 10 bold"),justify="center", relief=SOLID)
e_height.grid(row=2, column=1, columnspan=1,pady=10,padx=3)
